...
class PaginatedTable extends Component {
    ...
    render() {
        ...
        let data = (typeof this.props.payload === 'undefined' && typeof this.props.apiUrl !== 'undefined' && typeof this.props.paginatorList !== 'undefined') ? this.props.paginatorList.data.result: this.props.payload;
