...
let baseUrlTempEdge = process.env.REACT_APP_BASE_URL_TEMPEDGE; //***Must change this URL in the actions file as well***
let baseUrlFaceRecognition = process.env.REACT_APP_BASE_URL_FACERE_COGNITION;
