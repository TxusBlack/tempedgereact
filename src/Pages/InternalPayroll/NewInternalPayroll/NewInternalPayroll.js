...
class NewInternalPayroll extends Component {
    ...
    ActiveLanguageAddTranslation(this.props.activeLanguage, this.props.addTranslationForLanguage)
      ...
      .catch((err) => {
        if (!this.state.error) {
          ...
          this.fireNotification('Error', this.props.translate('com.tempedge.msg.label.undefine'));
        }
      });
  }
  ...
  calcTotals = (fieldName) => {
    ...
    new Promise((resolve, reject) => {
      ...
      let weekTotals = [this.state.total_mon, this.state.total_tue, this.state.total_wed, this.state.total_thu, this.state.total_fri, this.state.total_sat, this.state.total_sun];
      let fullTotal = 0;
    ...
    return (
      <Container title="com.tempedge.msg.label.mytimesheet" btns={btns}>
        <div className="col-12">
          <div className="row">
            <div className="col-sd-12 col-md-8"></div>
            <div className="col-sd-12 col-md-2"></div>
            <div className="col-sd-12 col-md-2 text-right tempedge-control-label "></div>
          </div>
          <div className="row">
            <div className="col-sd-12 col-md-8 control-label text-right"></div>
          </div>
          <div className="row">
              ...
              <table className="table table-striped">
                <thead>
                  <tr>
                    ...
                    <th className="table-header-mid text-center">
                      {translate('com.tempedge.msg.label.mon')} <br></br> {this.state.mon ? String(this.state.mon) : ''}
                    </th>
                    <th className="table-header-mid text-center">
                      {translate('com.tempedge.msg.label.tue')} <br></br> {this.state.tue ? this.state.tue : ''}
                    </th>
                    <th className="table-header-mid text-center">
                      {translate('com.tempedge.msg.label.wed')} <br></br> {this.state.wed ? this.state.wed : ''}
                    </th>
                    <th className="table-header-mid text-center">
                      {translate('com.tempedge.msg.label.thu')} <br></br> {this.state.thu ? this.state.thu : ''}
                    </th>
                    <th className="table-header-mid text-center">
                      {translate('com.tempedge.msg.label.fri')} <br></br> {this.state.fri ? this.state.fri : ''}
                    </th>
                    <th className="table-header-mid text-center">
                ...
                <tbody>
                        ...
                        return (
                          <tr className="tableRow" key={act.payrollActivityId}>
                            ...
                            <td className="table-content text-center">
                              <input
                                value={this.state['mon' + act.payrollActivityId]}
                                name={'mon' + act.payrollActivityId}
                                className="form-control tempEdge-input-box payroll-input text-center"
                                maxLength="6"
                            ...
                            <td className="table-content text-center">
                              <input
                                type="text"
                                value={this.state['tue' + act.payrollActivityId] ? this.state['tue' + act.payrollActivityId] : ''}
                            ...
                            <td className="table-content text-center">
                              <input
                                type="text"
                                value={this.state['wed' + act.payrollActivityId] ? this.state['wed' + act.payrollActivityId] : ''}
                            ...
                            <td className="table-content text-center">
                              <input
                                type="text"
                                value={this.state['thu' + act.payrollActivityId] ? this.state['thu' + act.payrollActivityId] : ''}
                            ...
                            <td className="table-content text-center">
                              <input
                                type="text"
                                value={this.state['fri' + act.payrollActivityId] ? this.state['fri' + act.payrollActivityId] : ''}
                            ...
                            <td className="table-content text-center">
                              <input
                                type="text"
                                value={this.state['sat' + act.payrollActivityId] ? this.state['sat' + act.payrollActivityId] : ''}
                            ...
                            <td className="table-content text-center">
                              <input
                                type="text"
                                value={this.state['sun' + act.payrollActivityId] ? this.state['sun' + act.payrollActivityId] : ''}
                  ...
                  <tr className="tableRow text-center">
                    <td className="table-content text-uppercase">{translate('com.tempedge.msg.label.total')}</td>
...
let mapStateToProps = (state) => {
  return {
    activityList: state.tempEdge.activityList && state.tempEdge.activityList.data && state.tempEdge.activityList.data.result ? state.tempEdge.activityList.data.result : []
  };
};

NewInternalPayroll.propTypes = {
