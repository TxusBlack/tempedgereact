...
class NewInternalPayroll extends Component {
    ...
    componentDidMount = async()=> {
        await this.props.tempedgeAPI(activityListURL, { orgId: 1 }, GET_ACTIVITY_LIST);
...
export default withLocalize(connect(mapStateToProps, { push, tempedgeAPI })(NewInternalPayroll));
