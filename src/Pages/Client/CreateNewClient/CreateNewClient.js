...
class CreateNewClient extends Component {
  ...
  render(){
    ...
    let modal = (this.props.clientDepartments !== undefined)? <ModalSimple content={this.state.departmentContent} open={this.state.showModal} onClose={this.onClose} />: "";
    ...
    return(
      <div className="wizard-create-agency">
        ...
        <div className="wizard-wrapper">
          {page === 1 && <WizardCreateNewClientFirstPage  onSubmit={this.nextPage} renderClientDepartments={this.renderClientDepartments} setDepartmentList={this.setDepartmentList} departmentList={this.state.departmentList} {...this.props} />}
          {page === 2 && <WizardCreateNewClientSecondPage  previousPage={this.previousPage} onSubmit={this.nextPage} renderClientDepartments={this.renderClientDepartments} setDepartmentList={this.setDepartmentList} departmentList={this.state.departmentList} {...this.props} />}
          {page === 3 && <WizardCreateNewClientThirdPage   previousPage={this.previousPage} onSubmit={this.onSubmit} renderClientDepartments={this.renderClientDepartments} setDepartmentList={this.setDepartmentList} departmentList={this.state.departmentList} {...this.props} />}
          { modal }
        </div>
      </div>
    );
...
export default connect(mapStateToProps, { notify, getList, reset  })(CreateNewClient);
