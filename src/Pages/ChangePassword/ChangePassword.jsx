              ...
              <div className="panel panel-default login-form-panel">
                ...
                <form className="panel-body" onSubmit={this.props.handleSubmit(this.onSubmit)}>
                    <div className="form-group">
                      <p className="text-left label-p">Current password</p>
                      <Field name="currentPassword" type="text" placeholder="Enter your current password" category="person" component={InputBox} />
                    </div>
                    <div className="form-group">
                      <p className="text-left label-p">New password</p>
                      <Field name="newPassword" type="password" placeholder="Enter password"category="person" component={InputBox} />
                    </div>
