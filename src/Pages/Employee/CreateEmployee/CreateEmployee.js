...
let mapStateToProps = (state) => {
  ...
  return {
    ...
    orgDepartmentList: state.tempEdge.orgDepartmentList && typeof state.tempEdge.orgDepartmentList.data !== 'undefined' ? state.tempEdge.orgDepartmentList.data.content : [],
