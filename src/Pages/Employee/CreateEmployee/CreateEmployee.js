...
let mapStateToProps = (state) => {
  ...
  return {
    ...
    orgDepartmentList:
      state.tempEdge.orgDepartmentList && typeof state.tempEdge.orgDepartmentList !== 'undefined' && typeof state.tempEdge.orgDepartmentList.data.content !== 'undefined'
